...
export const SkillsComponent = () => {
  return (
    <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" className="image-container lg:max-w-96 max-w-full flex bg-[#282828] px-2.5 py-1 rounded-[15px] gap-1.5 border border-t-[#484848] border-b-[#282828] border-x-[#484848]">
    <div className="image">
